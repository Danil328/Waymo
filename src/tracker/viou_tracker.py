...
def track_viou(frame_buffer: List[np.ndarray], detections: List[List[Dict[str, int]]],
               sigma_l, sigma_h, sigma_iou, t_min, ttl, tracker_type, keep_upper_height_ratio):
    """ V-IOU Tracker.
    See "Extending IOU Based Multi-Object Tracking by Visual Information by E. Bochinski, T. Senst, T. Sikora" for
    more information.

    Args:
         frame_buffer (str): ALL frames.
