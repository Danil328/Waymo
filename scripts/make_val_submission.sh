...
cd ../Waymo/src
python make_submission.py ../work_dirs/${cfg_name}/val_predicts.pkl \
                            --annotation ../data/annotations/val_annotation.json \
                            --output ../work_dirs/${cfg_name}/val_predicts.bin

cd ../waymo-open-dataset/

sub_dir=/Projects/Waymo/work_dirs/${cfg_name}/val_submission
if [[ -d ${sub_dir} ]]; then rm -Rf ${sub_dir}; fi
mkdir ${sub_dir}

./bazel-bin/waymo_open_dataset/metrics/tools/create_submission \
            --input_filenames /Projects/Waymo/work_dirs/${cfg_name}/val_predicts.bin \
            --output_filename /Projects/Waymo/work_dirs/${cfg_name}/val_submission/model \
            --submission_filename /Projects/Waymo/waymo-open-dataset/waymo_open_dataset/metrics/tools/submission.txtpb

tar czvf /Projects/Waymo/work_dirs/${cfg_name}/val_submission.tar.gz /Projects/Waymo/work_dirs/${cfg_name}/val_submission/